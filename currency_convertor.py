...
root.title("Jarvis Currency Convertor")

Tops = Frame(root, bg = '#e6e5e5', pady=2, width=1850, height=100, relief="ridge")
Tops.grid(row=0, column=0)

headlabel = tk.Label(Tops, font=('lato black', 19, 'bold'), text='Jarvis Currency Convertor',
                    bg='#e6e5e5', fg='black')
...
FromCurrency_option.grid(row=3, column=1, ipadx=15, sticky=E)
ToCurrency_option.grid(row=4, column=1, ipadx=15, sticky=E)
